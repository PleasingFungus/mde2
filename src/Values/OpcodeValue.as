package Values {
	...
	public class OpcodeValue extends FixedValue {
		...
		public static const OP_ADDM:OpcodeValue = new OpcodeValue("ADDM", 14, "Set memory at the target value to the sum of the source value and the destination value.");
