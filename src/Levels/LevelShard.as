package Levels {
	...
	public class LevelShard {
		...
		public static const DELAY:LevelShard = new LevelShard("Delay", [], [SysDelayClock, Delay], 40, 1, true);
		...
		public static const SPD:LevelShard = new LevelShard("Speed", [], [Demux, Equals], 0.2, 2);
